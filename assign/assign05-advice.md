...
virtual registers, this is great.  This provides a fallback for
...
a peephole analysis transforms an `InstructionSequence` (i.e., a basic block)
...
the blocks of the original `ControlFlowGraph`. (The `ControlFlowGraphTransform`
class is provided to make it straightforward to implement optimizations
this way: see the
[How/where to implement optimizations](assign05.htmlhowwhere-to-implement-optimizations)
...
live at the end of any basic block.  (If you represent
...
live virtual registers analysis, `include/live_vregs.h`, does exactly this!)
